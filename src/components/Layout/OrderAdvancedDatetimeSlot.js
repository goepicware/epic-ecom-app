...
import { uniqueID, deliveryId, pickupId, apiUrl } from "../Settings/Config";
...
class OrderAdvancedDatetimeSlot extends Component {
  ...
  componentWillReceiveProps(propsDtTm) {
    if (Object.keys(propsDtTm).length > 0) {
      ...
      var sldOutletId = this.props.outletID;
        ...
        .then((res) => {
          ...
          this.setState(
            ...
            function () {
              ...
              this.props.setdateTimeFlg("slotType", timeSlotType);
            }.bind(this)
          );
