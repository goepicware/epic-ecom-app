...
import { cnvrtStr } from "../Settings/SettingHelper";
...
class OrderAdvancedDatetimeSlot extends Component {
  ...
  componentWillReceiveProps(propsDtTm) {
    console.log(propsDtTm, "propsDtTmpropsDtTmpropsDtTmpropsDtTm");
    if (Object.keys(propsDtTm).length > 0) {
      ...
      console.log(getDateTimeFlg, "getDateTimeFlggetDateTimeFlg");
  ...
  getAvailableDates(sldAvilablityId, orderTatTm) {
    console.log(sldAvilablityId, 'sldAvilablityIdsldAvilablityIdsldAvilablityId')
    if (sldAvilablityId !== "") {
      axios
        .get(
          apiUrl +
            "timeSlot/getslotdetail?uniqueID=" +
            uniqueID +
            "&availabilityID=" +
            sldAvilablityId +
        ...
        .then((res) => {
            ...
            if (Object.keys(timeslotData).length > 0) {
              holidaysListArr =
                Object.keys(timeslotData).length > 0
                  ...
                  : [];
              console.log(timeslotData, "timeslotDatatimeslotData");
          ...
          console.log(resultSetArr, "resultSetArrresultSetArr");
          this.setState(
            {
  ...
  setOrderDateFun() {
    ...
    console.log(resultSetdata, "resultSetdataresultSetdata");
    ...
    if (Object.keys(resultSetdata).length > 0) {
      ...
      this.setState({startDate: new Date(orderDateTime)}) */
     
      var orderDateTime = this.props.hdrState.orderDateTime;
      console.log(orderDateTime, 'orderDateTimedsadadadadasd')
      ...
      if (
        ...
        timeSlotListData.map(function (item) {
          if (Object.keys(item).length > 0) {
            var slotTime1 =
              item.slot_time1 !== "" ? item.slot_time1.split(":") : [];
            var slotTime2 =
              item.slot_time2 !== "" ? item.slot_time2.split(":") : [];
            if (
          ...
          <div className="syd_merge">
            <div className="syd_date">
              {this.props.labelDateName !== "" &&
                ...
                typeof this.props.labelDateName !== "undefined" && (
                  <h6>{this.props.labelDateName}</h6>
                )}
            ...
            {this.state.timeSlotType === "2" ? (
              <div className="syd_time">
                {this.props.labelTimeName !== "" &&
                  ...
                  typeof this.props.labelTimeName !== "undefined" && (
                    <h6>{this.props.labelTimeName}</h6>
                  )}
                <div className="form-group">
